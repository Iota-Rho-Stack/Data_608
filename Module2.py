...
fig = go.Figure(go.Histogram2d(x=x, y=y,
        autobinx=False,
        xbins=dict(start=1850, end=2000, size = 10),
        autobiny=False,
        ybins=dict(start=0, end=50, size= 10)
        ))

fig.update_layout(
    title="Heatmap of Buildings Constructed with Fifty or Fewer Floors per Decade",
    xaxis_title="Year; Grouped By Decade",
    yaxis_title="Number of Floors; Grouped by ten",
)
...
fig = go.Figure(go.Histogram2d(x=x, y=y,
        ...
        xbins=dict(start=1850, end=2000, size = 10),
        autobiny=False,
        ybins=dict(start=50, end=200, size= 10)
        ))

fig.update_layout(
    title="Heatmap of buildings constructed with fifty or more floors per decade",
    xaxis_title="Year; Grouped By Decade",
    yaxis_title="Number of Floors; Grouped By Ten",
)
